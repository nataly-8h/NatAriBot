...
public class NatAriBotJuego extends JPanel implements Runnable, KeyListener, MouseListener, MouseMotionListener {
	...
	private Image img, derTrue, derFalse, downTrue, downFalse, izqTrue, izqFalse, borde, gameBox, progBox, pro1, pro2,
			pro3, pro4, ifRed, ifYell, ifGreen, ifBlue, ifAll, ifNone, barraGarra, garraDer, garraIzq, clear, skip, rapido, rapidotrue;
	...
	private int espacios, actualpos, maxCajas, coorToolx, coorTooly, posGarra, velocidad, maxAcciones, numAcciones;

	private String nivel;

	private boolean play, gameOver, flagDer, flagIzq, flagDown, flagProg1, flagProg2, flagProg3, flagProg4, flagIfRed,
			flagIfYell, flagIfGreen, flagIfBlue, flagIfAll, flagIfNone, hasCaja, win, fast;
	...
	public NatAriBotJuego() {
		...
		this.rapido = new ImageIcon("fast.png").getImage();
		this.rapidotrue = new ImageIcon("fastTrue.png").getImage();
	...
	public void paintComponent(Graphics g) {
		...
		//fasto
		if(!this.fast) {
			g.drawImage(this.rapido, 1099, 451, this);
		}else {
			g.drawImage(this.rapidotrue, 1099, 451, this);
		}
	...
	public void mouseClicked(MouseEvent e) {
		...
		}else if(e.getX() > 1099 && e.getX() < 1164 && e.getY() > 451 && e.getY() < 486 && this.play) {
			if(this.fast) {
				this.velocidad = 1;
				this.fast= false;
			}else {
	...
	public void mousePressed(MouseEvent e) {
		...
		//QUITAR HERRAMIENTAS
		else if (e.getX() > 155 && e.getX() < 170 && e.getY() > 454 && e.getY() < 496 && !this.play && 0<this.programa1.length) {
			if(this.programa1[0]!=null) {
				this.toolFlagger(this.programa1[0],this.programa1,0);
				if(this.programa1[0]!=null) {
				this.ifProgFlagger(this.programa1[0], this.programa1, 0);
				}
			}
		} else if(e.getX() > 170 && e.getX() < 220 && e.getY() > 454 && e.getY() < 496 && !this.play && 0<this.programa1.length) {
			if(this.programa1[0]!=null) {
				this.toolFlagger(this.programa1[0],this.programa1,0);
				if(this.programa1[0]!=null) {
				this.progIfFlagger(this.programa1[0], this.programa1, 0);
				}
			}
		}
		
		else if (e.getX() > 223 && e.getX() < 238 && e.getY() > 454 && e.getY() < 496 && !this.play && 1<this.programa1.length) {
			if(this.programa1[1]!=null) {
				this.toolFlagger(this.programa1[1],this.programa1,1);
				if(this.programa1[1]!=null) {
				this.ifProgFlagger(this.programa1[1], this.programa1, 1);
				}
			}
		} else if(e.getX() > 238 && e.getX() < 288 && e.getY() > 454 && e.getY() < 496 && !this.play && 1<this.programa1.length) {
			if(this.programa1[1]!=null) {
				this.toolFlagger(this.programa1[1],this.programa1,1);
				if(this.programa1[1]!=null) {
				this.progIfFlagger(this.programa1[1], this.programa1, 1);
				}
			}
		}
		
		else if (e.getX() > 291 && e.getX() < 306 && e.getY() > 454 && e.getY() < 496 && !this.play && 2<this.programa1.length) {
			if(this.programa1[2]!=null) {
				this.toolFlagger(this.programa1[2],this.programa1,2);
				if(this.programa1[2]!=null) {
				this.ifProgFlagger(this.programa1[2], this.programa1, 2);
				}
			}
		} else if(e.getX() > 306 && e.getX() < 356 && e.getY() > 454 && e.getY() < 496 && !this.play && 2<this.programa1.length) {
			if(this.programa1[2]!=null) {
				this.toolFlagger(this.programa1[2],this.programa1,2);
				if(this.programa1[2]!=null) {
				this.progIfFlagger(this.programa1[2], this.programa1, 2);
				}
			}
		}
		
		else if (e.getX() > 359 && e.getX() < 374 && e.getY() > 454 && e.getY() < 496 && !this.play && 3<this.programa1.length) {
			if(this.programa1[3]!=null) {
				this.toolFlagger(this.programa1[3],this.programa1,3);
				if(this.programa1[3]!=null) {
				this.ifProgFlagger(this.programa1[3], this.programa1, 3);
				}
			}
		} else if(e.getX() > 374 && e.getX() < 424 && e.getY() > 454 && e.getY() < 496 && !this.play && 3<this.programa1.length) {
			if(this.programa1[3]!=null) {
				this.toolFlagger(this.programa1[3],this.programa1,3);
				if(this.programa1[3]!=null) {
				this.progIfFlagger(this.programa1[3], this.programa1, 3);
				}
			}
		}
		
		else if (e.getX() > 427 && e.getX() < 442 && e.getY() > 454 && e.getY() < 496 && !this.play && 4<this.programa1.length) {
			if(this.programa1[4]!=null) {
				this.toolFlagger(this.programa1[4],this.programa1,4);
				if(this.programa1[4]!=null) {
				this.ifProgFlagger(this.programa1[4], this.programa1, 4);
				}
			}
		} else if(e.getX() > 442 && e.getX() < 492 && e.getY() > 454 && e.getY() < 496 && !this.play && 4<this.programa1.length) {
			if(this.programa1[4]!=null) {
				this.toolFlagger(this.programa1[4],this.programa1,4);
				if(this.programa1[4]!=null) {
					this.progIfFlagger(this.programa1[4], this.programa1, 4);
				}
			}
		}
		
		else if (e.getX() > 495 && e.getX() < 510 && e.getY() > 454 && e.getY() < 496 && !this.play && 5<this.programa1.length) {
			if(this.programa1[5]!=null) {
				this.toolFlagger(this.programa1[5],this.programa1,5);
				if(this.programa1[5]!=null) {
				this.ifProgFlagger(this.programa1[5], this.programa1, 5);
				}
			}
		} else if(e.getX() > 510 && e.getX() < 560 && e.getY() > 454 && e.getY() < 496 && !this.play && 5<this.programa1.length) {
			if(this.programa1[5]!=null) {
				this.toolFlagger(this.programa1[5],this.programa1,5);
				if(this.programa1[5]!=null) {
				this.progIfFlagger(this.programa1[5], this.programa1, 5);
				}
			}
		}
		
		else if (e.getX() > 563 && e.getX() < 578 && e.getY() > 454 && e.getY() < 496 && !this.play && 6<this.programa1.length) {
			if(this.programa1[6]!=null) {
				this.toolFlagger(this.programa1[6],this.programa1,6);
				if(this.programa1[6]!=null) {
				this.ifProgFlagger(this.programa1[6], this.programa1, 6);
				}
			}
		} else if(e.getX() > 578 && e.getX() < 628 && e.getY() > 454 && e.getY() < 496 && !this.play && 6<this.programa1.length) {
			if(this.programa1[6]!=null) {
				this.toolFlagger(this.programa1[6],this.programa1,6);
				if(this.programa1[6]!=null) {
				this.progIfFlagger(this.programa1[6], this.programa1, 6);
				}
			}
		}
		...
		//SEGUNDO PROGRAMA
			...
			if(this.programa2[0]!=null) {
				this.toolFlagger(this.programa2[0],this.programa2,0);
				if(this.programa2[0]!=null) {
				this.ifProgFlagger(this.programa2[0], this.programa2, 0);
				}
			}
		} else if(e.getX() > 170 && e.getX() < 220 && e.getY() > 510 && e.getY() < 552 && !this.play && 0<this.programa2.length) {
			if(this.programa2[0]!=null) {
				this.toolFlagger(this.programa2[0],this.programa2,0);
				if(this.programa2[0]!=null) {
				this.progIfFlagger(this.programa2[0], this.programa2, 0);
				}
			}
		}
		
		else if (e.getX() > 223 && e.getX() < 238 && e.getY() > 510 && e.getY() < 552 && !this.play && 1<this.programa2.length) {
			if(this.programa2[1]!=null) {
				this.toolFlagger(this.programa2[1],this.programa2,1);
				if(this.programa2[1]!=null) {
				this.ifProgFlagger(this.programa2[1], this.programa2, 1);
				}
			}
		} else if(e.getX() > 238 && e.getX() < 288 && e.getY() > 510 && e.getY() < 552 && !this.play && 1<this.programa2.length) {
			if(this.programa2[1]!=null) {
				this.toolFlagger(this.programa2[1],this.programa2,1);
				if(this.programa2[1]!=null) {
				this.progIfFlagger(this.programa2[1], this.programa2, 1);
				}
			}
		}
		
		else if (e.getX() > 291 && e.getX() < 306 && e.getY() > 510 && e.getY() < 552 && !this.play && 2<this.programa2.length) {
			if(this.programa2[2]!=null) {
				this.toolFlagger(this.programa2[2],this.programa2,2);
				if(this.programa2[2]!=null) {
				this.ifProgFlagger(this.programa2[2], this.programa2, 2);
				}
			}
		} else if(e.getX() > 306 && e.getX() < 356 && e.getY() > 510 && e.getY() < 552 && !this.play && 2<this.programa2.length) {
			if(this.programa2[2]!=null) {
				this.toolFlagger(this.programa2[2],this.programa2,2);
				if(this.programa2[2]!=null) {
				this.progIfFlagger(this.programa2[2], this.programa2, 2);
				}
			}
		}
		
		else if (e.getX() > 359 && e.getX() < 374 && e.getY() > 510 && e.getY() < 552 && !this.play && 3<this.programa2.length) {
			if(this.programa2[3]!=null) {
				this.toolFlagger(this.programa2[3],this.programa2,3);
				if(this.programa2[3]!=null) {
				this.ifProgFlagger(this.programa2[3], this.programa2, 3);
				}
			}
		} else if(e.getX() > 374 && e.getX() < 424 && e.getY() > 510 && e.getY() < 552 && !this.play && 3<this.programa2.length) {
			if(this.programa2[3]!=null) {
				this.toolFlagger(this.programa2[3],this.programa2,3);
				if(this.programa2[3]!=null) {
				this.progIfFlagger(this.programa2[3], this.programa2, 3);
				}
			}
		}
		
		else if (e.getX() > 427 && e.getX() < 442 && e.getY() > 510 && e.getY() < 552 && !this.play && 4<this.programa2.length) {
			if(this.programa2[4]!=null) {
				this.toolFlagger(this.programa2[4],this.programa2,4);
				if(this.programa2[4]!=null) {
				this.ifProgFlagger(this.programa2[4], this.programa2, 4);
				}
			}
		} else if(e.getX() > 442 && e.getX() < 492 && e.getY() > 510 && e.getY() < 552 && !this.play && 4<this.programa2.length) {
			if(this.programa2[4]!=null) {
				this.toolFlagger(this.programa2[4],this.programa2,4);
				if(this.programa2[4]!=null) {
					this.progIfFlagger(this.programa2[4], this.programa2, 4);
				}
			}
		}
		
		else if (e.getX() > 495 && e.getX() < 510 && e.getY() > 510 && e.getY() < 552 && !this.play && 5<this.programa2.length) {
			if(this.programa2[5]!=null) {
				this.toolFlagger(this.programa2[5],this.programa2,5);
				if(this.programa2[5]!=null) {
				this.ifProgFlagger(this.programa2[5], this.programa2, 5);
				}
			}
		} else if(e.getX() > 510 && e.getX() < 560 && e.getY() > 510 && e.getY() < 552 && !this.play && 5<this.programa2.length) {
			if(this.programa2[5]!=null) {
				this.toolFlagger(this.programa2[5],this.programa2,5);
				if(this.programa2[5]!=null) {
				this.progIfFlagger(this.programa2[5], this.programa2, 5);
				}
			}
		}
		
		else if (e.getX() > 563 && e.getX() < 578 && e.getY() > 510 && e.getY() < 552 && !this.play && 6<this.programa2.length) {
			if(this.programa2[6]!=null) {
				this.toolFlagger(this.programa2[6],this.programa2,6);
				if(this.programa2[6]!=null) {
				this.ifProgFlagger(this.programa2[6], this.programa2, 6);
				}
			}
		} else if(e.getX() > 578 && e.getX() < 628 && e.getY() > 510 && e.getY() < 552 && !this.play && 6<this.programa2.length) {
			if(this.programa2[6]!=null) {
				this.toolFlagger(this.programa2[6],this.programa2,6);
				if(this.programa1[6]!=null) {
		...
		//PROGRAMA 3
		else if (e.getX() > 155 && e.getX() < 170 && e.getY() > 566 && e.getY() < 608 && !this.play && 0<this.programa3.length) {
			if(this.programa3[0]!=null) {
				this.toolFlagger(this.programa3[0],this.programa3,0);
				if(this.programa3[0]!=null) {
				this.ifProgFlagger(this.programa3[0], this.programa3, 0);
				}
			}
		} else if(e.getX() > 170 && e.getX() < 220 && e.getY() > 566 && e.getY() < 608 && !this.play && 0<this.programa3.length) {
			if(this.programa3[0]!=null) {
				this.toolFlagger(this.programa3[0],this.programa3,0);
				if(this.programa3[0]!=null) {
				this.progIfFlagger(this.programa3[0], this.programa3, 0);
				}
			}
		}
		
		else if (e.getX() > 223 && e.getX() < 238 && e.getY() > 566 && e.getY() < 608 && !this.play && 1<this.programa3.length) {
			if(this.programa3[1]!=null) {
				this.toolFlagger(this.programa3[1],this.programa3,1);
				if(this.programa3[1]!=null) {
				this.ifProgFlagger(this.programa3[1], this.programa3, 1);
				}
			}
		} else if(e.getX() > 238 && e.getX() < 288 && e.getY() > 566 && e.getY() < 608 && !this.play && 1<this.programa3.length) {
			if(this.programa3[1]!=null) {
				this.toolFlagger(this.programa3[1],this.programa3,1);
				if(this.programa3[1]!=null) {
				this.progIfFlagger(this.programa3[1], this.programa3, 1);
				}
			}
		}
		
		else if (e.getX() > 291 && e.getX() < 306 && e.getY() > 566 && e.getY() < 608 && !this.play && 2<this.programa3.length) {
			if(this.programa3[2]!=null) {
				this.toolFlagger(this.programa3[2],this.programa3,2);
				if(this.programa3[2]!=null) {
				this.ifProgFlagger(this.programa3[2], this.programa3, 2);
				}
			}
		} else if(e.getX() > 306 && e.getX() < 356 && e.getY() > 566 && e.getY() < 608 && !this.play && 2<this.programa3.length) {
			if(this.programa3[2]!=null) {
				this.toolFlagger(this.programa3[2],this.programa3,2);
				if(this.programa3[2]!=null) {
				this.progIfFlagger(this.programa3[2], this.programa3, 2);
				}
			}
		}
		
		else if (e.getX() > 359 && e.getX() < 374 && e.getY() > 566 && e.getY() < 608 && !this.play && 3<this.programa3.length) {
			if(this.programa3[3]!=null) {
				this.toolFlagger(this.programa3[3],this.programa3,3);
				if(this.programa3[3]!=null) {
				this.ifProgFlagger(this.programa3[3], this.programa3, 3);
				}
			}
		} else if(e.getX() > 374 && e.getX() < 424 && e.getY() > 566 && e.getY() < 608 && !this.play && 3<this.programa3.length) {
			if(this.programa3[3]!=null) {
				this.toolFlagger(this.programa3[3],this.programa3,3);
				if(this.programa3[3]!=null) {
				this.progIfFlagger(this.programa3[3], this.programa3, 3);
				}
			}
		}
		
		else if (e.getX() > 427 && e.getX() < 442 && e.getY() > 566 && e.getY() < 608 && !this.play && 4<this.programa3.length) {
			if(this.programa3[4]!=null) {
				this.toolFlagger(this.programa3[4],this.programa3,4);
				if(this.programa3[4]!=null) {
				this.ifProgFlagger(this.programa3[4], this.programa3, 4);
				}
			}
		} else if(e.getX() > 442 && e.getX() < 492 && e.getY() > 566 && e.getY() < 608 && !this.play && 4<this.programa3.length) {
			if(this.programa3[4]!=null) {
				this.toolFlagger(this.programa3[4],this.programa3,4);
				if(this.programa3[4]!=null) {
					this.progIfFlagger(this.programa3[4], this.programa3, 4);
				}
			}
		}
		
		else if (e.getX() > 495 && e.getX() < 510 && e.getY() > 566 && e.getY() < 608 && !this.play && 5<this.programa3.length) {
			if(this.programa3[5]!=null) {
				this.toolFlagger(this.programa3[5],this.programa3,5);
				if(this.programa3[5]!=null) {
				this.ifProgFlagger(this.programa3[5], this.programa3, 5);
				}
			}
		} else if(e.getX() > 510 && e.getX() < 560 && e.getY() > 566 && e.getY() < 608 && !this.play && 5<this.programa3.length) {
			if(this.programa3[5]!=null) {
				this.toolFlagger(this.programa3[5],this.programa3,5);
				if(this.programa3[5]!=null) {
				this.progIfFlagger(this.programa3[5], this.programa3, 5);
				}
			}
		}
		
		else if (e.getX() > 563 && e.getX() < 578 && e.getY() > 566 && e.getY() < 608 && !this.play && 6<this.programa3.length) {
			if(this.programa3[6]!=null) {
				this.toolFlagger(this.programa3[6],this.programa3,6);
				if(this.programa1[6]!=null) {
				this.ifProgFlagger(this.programa3[6], this.programa3, 6);
				}
			}
		} else if(e.getX() > 578 && e.getX() < 628 && e.getY() > 566 && e.getY() < 608 && !this.play && 6<this.programa3.length) {
			if(this.programa3[6]!=null) {
				this.toolFlagger(this.programa3[6],this.programa3,6);
				if(this.programa3[6]!=null) {
				this.progIfFlagger(this.programa3[6], this.programa3, 6);
				}
			}
		}
		...
		else if (e.getX() > 155 && e.getX() < 170 && e.getY() > 622 && e.getY() < 664 && !this.play && 0<this.programa4.length) {
			if(this.programa4[0]!=null) {
				this.toolFlagger(this.programa4[0],this.programa4,0);
				if(this.programa4[0]!=null) {
				this.ifProgFlagger(this.programa4[0], this.programa4, 0);
				}
			}
		} else if(e.getX() > 170 && e.getX() < 220 && e.getY() > 622 && e.getY() < 664 && !this.play && 0<this.programa4.length) {
			if(this.programa4[0]!=null) {
				this.toolFlagger(this.programa4[0],this.programa4,0);
				if(this.programa4[0]!=null) {
				this.progIfFlagger(this.programa4[0], this.programa4, 0);
				}
			}
		}
		
		else if (e.getX() > 223 && e.getX() < 238 && e.getY() > 622 && e.getY() < 664 && !this.play && 1<this.programa4.length) {
			if(this.programa4[1]!=null) {
				this.toolFlagger(this.programa4[1],this.programa4,1);
				if(this.programa4[1]!=null) {
				this.ifProgFlagger(this.programa4[1], this.programa4, 1);
				}
			}
		} else if(e.getX() > 238 && e.getX() < 288 && e.getY() > 622 && e.getY() < 664 && !this.play && 1<this.programa4.length) {
			if(this.programa4[1]!=null) {
				this.toolFlagger(this.programa4[1],this.programa4,1);
				if(this.programa4[1]!=null) {
				this.progIfFlagger(this.programa4[1], this.programa4, 1);
				}
			}
		}
		
		else if (e.getX() > 291 && e.getX() < 306 && e.getY() > 622 && e.getY() < 664 && !this.play && 2<this.programa4.length) {
			if(this.programa4[2]!=null) {
				this.toolFlagger(this.programa4[2],this.programa4,2);
				if(this.programa4[2]!=null) {
				this.ifProgFlagger(this.programa4[2], this.programa4, 2);
				}
			}
		} else if(e.getX() > 306 && e.getX() < 356 && e.getY() > 622 && e.getY() < 664 && !this.play && 2<this.programa4.length) {
			if(this.programa4[2]!=null) {
				this.toolFlagger(this.programa4[2],this.programa4,2);
				if(this.programa4[2]!=null) {
				this.progIfFlagger(this.programa4[2], this.programa4, 2);
				}
			}
		}
		
		else if (e.getX() > 359 && e.getX() < 374 && e.getY() > 622 && e.getY() < 664 && !this.play && 3<this.programa4.length) {
			if(this.programa4[3]!=null) {
				this.toolFlagger(this.programa4[3],this.programa4,3);
				if(this.programa4[3]!=null) {
				this.ifProgFlagger(this.programa4[3], this.programa4, 3);
				}
			}
		} else if(e.getX() > 374 && e.getX() < 424 && e.getY() > 622 && e.getY() < 664 && !this.play && 3<this.programa4.length) {
			if(this.programa4[3]!=null) {
				this.toolFlagger(this.programa4[3],this.programa4,3);
				if(this.programa4[3]!=null) {
				this.progIfFlagger(this.programa4[3], this.programa4, 3);
				}
			}
		}
		
		else if (e.getX() > 427 && e.getX() < 442 && e.getY() > 622 && e.getY() < 664 && !this.play && 4<this.programa4.length) {
			if(this.programa4[4]!=null) {
				this.toolFlagger(this.programa4[4],this.programa4,4);
				if(this.programa4[4]!=null) {
				this.ifProgFlagger(this.programa4[4], this.programa4, 4);
				}
			}
		} else if(e.getX() > 442 && e.getX() < 492 && e.getY() > 622 && e.getY() < 664 && !this.play && 4<this.programa4.length) {
			if(this.programa4[4]!=null) {
				this.toolFlagger(this.programa4[4],this.programa4,4);
				if(this.programa4[4]!=null) {
					this.progIfFlagger(this.programa4[4], this.programa4, 4);
				}
			}
		}
		
		else if (e.getX() > 495 && e.getX() < 510 && e.getY() > 622 && e.getY() < 664 && !this.play && 5<this.programa4.length) {
			if(this.programa4[5]!=null) {
				this.toolFlagger(this.programa4[5],this.programa4,5);
				if(this.programa4[5]!=null) {
				this.ifProgFlagger(this.programa4[5], this.programa4, 5);
				}
			}
		} else if(e.getX() > 510 && e.getX() < 560 && e.getY() > 622 && e.getY() < 664 && !this.play && 5<this.programa4.length) {
			if(this.programa4[5]!=null) {
				this.toolFlagger(this.programa4[5],this.programa4,5);
				if(this.programa4[5]!=null) {
				this.progIfFlagger(this.programa4[5], this.programa4, 5);
				}
			}
		}
		
		else if (e.getX() > 563 && e.getX() < 578 && e.getY() > 622 && e.getY() < 664 && !this.play && 6<this.programa4.length) {
			if(this.programa4[6]!=null) {
				this.toolFlagger(this.programa4[6],this.programa4,6);
				if(this.programa4[6]!=null) {
				this.ifProgFlagger(this.programa4[6], this.programa4, 6);
				}
			}
		} else if(e.getX() > 578 && e.getX() < 628 && e.getY() > 622 && e.getY() < 664 && !this.play && 6<this.programa4.length) {
			if(this.programa4[6]!=null) {
				this.toolFlagger(this.programa4[6],this.programa4,6);
				if(this.programa4[6]!=null) {
	...
	public void ifProgFlagger(Tool herramienta,Tool[] programa, int pos) {
		...
		//BLUE IF
			...
			this.flagIfBlue = true;
			programa[pos] = new Tool("der");
		} else if(herramienta.getAccion().equals("blueIfIzq")) {
			this.flagIfBlue = true;
			programa[pos] = new Tool("izq");
		} else if(herramienta.getAccion().equals("blueIfDown")) {
			this.flagIfBlue = true;
			programa[pos] = new Tool("down");
		} else if(herramienta.getAccion().equals("blueIfProg1")) {
			this.flagIfBlue = true;
			programa[pos] = new Tool("prog1");
		} else if(herramienta.getAccion().equals("blueIfProg2")) {
			this.flagIfBlue = true;
			programa[pos] = new Tool("prog2");
		} else if(herramienta.getAccion().equals("blueIfProg3")) {
			this.flagIfBlue = true;
			programa[pos] = new Tool("prog3");
		} else if(herramienta.getAccion().equals("blueIfProg4")) {
			this.flagIfBlue = true;
			programa[pos] = new Tool("prog4");
		} 
		...
		//YELLOW IF
			...
			this.flagIfYell = true;
			programa[pos] = new Tool("der");
		} else if(herramienta.getAccion().equals("yellIfIzq")) {
			this.flagIfYell = true;
			programa[pos] = new Tool("izq");
		} else if(herramienta.getAccion().equals("yellIfDown")) {
			this.flagIfYell = true;
			programa[pos] = new Tool("down");
		} else if(herramienta.getAccion().equals("yellIfProg1")) {
			this.flagIfYell = true;
			programa[pos] = new Tool("prog1");
		} else if(herramienta.getAccion().equals("yellIfProg2")) {
			this.flagIfYell = true;
			programa[pos] = new Tool("prog2");
		} else if(herramienta.getAccion().equals("yellIfProg3")) {
			this.flagIfYell = true;
			programa[pos] = new Tool("prog3");
		} else if(herramienta.getAccion().equals("yellIfProg4")) {
			this.flagIfYell = true;
			programa[pos] = new Tool("prog4");
		} 
		...
		//GREEN IF
			...
			this.flagIfGreen = true;
			programa[pos] = new Tool("der");
		} else if(herramienta.getAccion().equals("greenIfIzq")) {
			this.flagIfGreen = true;
			programa[pos] = new Tool("izq");
		} else if(herramienta.getAccion().equals("greenIfDown")) {
			this.flagIfGreen = true;
			programa[pos] = new Tool("down");
		} else if(herramienta.getAccion().equals("greenIfProg1")) {
			this.flagIfGreen = true;
			programa[pos] = new Tool("prog1");
		} else if(herramienta.getAccion().equals("greenIfProg2")) {
			this.flagIfGreen = true;
			programa[pos] = new Tool("prog2");
		} else if(herramienta.getAccion().equals("greenIfProg3")) {
			this.flagIfGreen = true;
			programa[pos] = new Tool("prog3");
		} else if(herramienta.getAccion().equals("greenIfProg4")) {
			this.flagIfGreen = true;
			programa[pos] = new Tool("prog4");
		} 
		...
		//ALL IF
			...
			this.flagIfAll = true;
			programa[pos] = new Tool("der");
		} else if(herramienta.getAccion().equals("allIfIzq")) {
			this.flagIfAll = true;
			programa[pos] = new Tool("izq");
		} else if(herramienta.getAccion().equals("allIfDown")) {
			this.flagIfAll = true;
			programa[pos] = new Tool("down");
		} else if(herramienta.getAccion().equals("allIfProg1")) {
			this.flagIfAll = true;
			programa[pos] = new Tool("prog1");
		} else if(herramienta.getAccion().equals("allIfProg2")) {
			this.flagIfAll = true;
			programa[pos] = new Tool("prog2");
		} else if(herramienta.getAccion().equals("allIfProg3")) {
			this.flagIfAll = true;
			programa[pos] = new Tool("prog3");
		} else if(herramienta.getAccion().equals("allIfProg4")) {
			this.flagIfAll = true;
			programa[pos] = new Tool("prog4");
		} 
		...
		//NONE IF
			...
			this.flagIfNone = true;
			programa[pos] = new Tool("der");
		} else if(herramienta.getAccion().equals("noneIfIzq")) {
			this.flagIfNone = true;
			programa[pos] = new Tool("izq");
		} else if(herramienta.getAccion().equals("noneIfDown")) {
			this.flagIfNone = true;
			programa[pos] = new Tool("down");
		} else if(herramienta.getAccion().equals("noneIfProg1")) {
			this.flagIfNone = true;
			programa[pos] = new Tool("prog1");
		} else if(herramienta.getAccion().equals("noneIfProg2")) {
			this.flagIfNone = true;
			programa[pos] = new Tool("prog2");
		} else if(herramienta.getAccion().equals("noneIfProg3")) {
			this.flagIfNone = true;
			programa[pos] = new Tool("prog3");
		} else if(herramienta.getAccion().equals("noneIfProg4")) {
			this.flagIfNone = true;
			programa[pos] = new Tool("prog4");
		}
	...
	public void progIfFlagger(Tool herramienta,Tool[] programa, int pos) {
		//RED IF
				if(herramienta.getAccion().equals("redIfDer")) {
					this.flagDer = true;
	...
	public void toolFlagger(Tool herramienta,Tool[] programa, int pos) {
		if(herramienta.getAccion().equals("der")) {
			this.flagDer = true;
			programa[pos] = null;
		} else if(herramienta.getAccion().equals("izq")) {
			...
			this.flagProg4 = true;
			programa[pos] = null;
		} else if(herramienta.getAccion().equals("ifRed")) {
			this.flagIfRed = true;
			programa[pos] = null;
	...
	public void derecha() {
		...
		while (n <= 90) {
			n+=velocidad;
			if (hasCaja) {
				this.caja.setX(this.caja.getX() + velocidad);
			}
			this.garra.setPosX(this.garra.getPosX() + velocidad);
			this.paintImmediately(0, 0, 1300, 1300);
		}
	}
	...
	public void bajar() {
		...
		while (n <= 315 - (cantidad * 50) && this.play) {
			...
			n+=velocidad;
			this.garra.setPosY(this.garra.getPosY() + velocidad);
			this.paintImmediately(0, 0, 1300, 1300);
		}
	}
